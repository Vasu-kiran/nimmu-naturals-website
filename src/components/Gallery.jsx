...
const galleryItems = [
  ...
  { id: 12, title: 'Paddy Fields', category: 'farm', aspect: 'landscape', color: 'from-amber-200/40 to-green-200/40', icon: '🌾', desc: 'Golden paddy fields glowing in the morning light' },
]
