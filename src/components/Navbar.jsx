      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="flex items-center justify-between h-16 md:h-20">
          <a href="#hero" className="flex items-center" aria-label="Nimmu Naturals home">
            <NimmuLogo className="h-10 md:h-12 w-auto text-ink" />
          </a>
          ...
          <div className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                ...
                className={`text-sm tracking-wide transition-colors duration-200 ${
                  activeSection === link.href ? 'text-green-deep' : 'text-ink/70 hover:text-ink'
                }`}
              >
                {link.name}
              </a>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-ink text-paper px-5 py-2.5 text-sm font-medium hover:bg-green-deep transition-colors duration-300"
            >
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="lg:hidden bg-paper border-t border-ink/10 overflow-hidden"
          >
            <div className="px-6 py-6 flex flex-col gap-1">
              {navLinks.map((link) => (
                <a
                  ...
                  className={`text-lg py-2 transition-colors ${
                    activeSection === link.href ? 'text-green-deep' : 'text-ink/80 hover:text-ink'
                  }`}
                >
                  {link.name}
                </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-3 inline-flex items-center justify-center gap-2 bg-ink text-paper px-6 py-3 font-medium"
              >
