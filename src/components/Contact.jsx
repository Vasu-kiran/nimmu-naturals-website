    ...
    <section id="contact" ref={ref} className="px-6 md:px-16 lg:px-24 py-20 md:py-28 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <motion.a href="https://wa.me/9010277831" target="_blank" rel="noopener noreferrer" variants={fadeInUp} initial="hidden" animate={isInView ? 'visible' : 'hidden'} transition={{ duration: 0.6, delay: 0.2 }}
            ...
            <p className="text-white font-semibold mt-2">+91 90102 77831</p>
          </motion.a>

          <motion.a href="tel:+919010277831" variants={fadeInUp} initial="hidden" animate={isInView ? 'visible' : 'hidden'} transition={{ duration: 0.6, delay: 0.35 }}
          ...
          <motion.a href="https://instagram.com/nimmu_naturals" target="_blank" rel="noopener noreferrer" variants={fadeInUp} initial="hidden" animate={isInView ? 'visible' : 'hidden'} transition={{ duration: 0.6, delay: 0.5 }}
            ...
            <p className="text-white font-semibold mt-2">@nimmu_naturals</p>
          </motion.a>
        </div>
      </div>
    </section>
