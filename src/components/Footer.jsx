        ...
        <div className="max-w-6xl mx-auto px-6 md:px-16 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
            <div>
              ...
              <p className="text-white/60 leading-relaxed text-sm">100% organic island farm in Gudapalli, Konaseema. With treasures from the Eastern Ghats. From our soil to your soul.</p>
            </div>
            <div>
              <h4 className="font-semibold mb-3 text-beige text-sm">Quick Links</h4>
              <div className="space-y-2">
                {[{ name: 'Our Story', href: '#story' }, { name: 'The Island', href: '#island' }, { name: 'Products', href: '#products' }, { name: 'Gallery', href: '#gallery' }, { name: 'Contact', href: '#contact' }].map((link) => (
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-white/50">
                ...
                <div className="flex gap-3 mt-3">
                  <a href="https://wa.me/91XXXXXXXXXX" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-green-500 transition-colors" aria-label="WhatsApp">
                  ...
                  <a href="https://instagram.com/nimmunaturals" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-pink-500 transition-colors" aria-label="Instagram">
          ...
          <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <p className="text-white/30 text-xs italic">From Soil to Soul &bull; Gudapalli, Konaseema</p>
          </div>
        </div>
      </div>
    </footer>
